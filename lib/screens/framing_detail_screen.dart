...
class FramingDetailScreen extends StatefulWidget {
  final FramingAuditForm audit;

  const FramingDetailScreen({Key? key, required this.audit}) : super(key: key);

  @override
  State<FramingDetailScreen> createState() => _FramingDetailScreenState();
}

class _FramingDetailScreenState extends State<FramingDetailScreen> {
  late FramingAuditForm audit;
  bool isAdmin = false;
  ...
  void _initializeFieldControllers() {
    ...
    fieldControllers['frameType'] = TextEditingController(
      text: audit.frameType,
    );
    fieldControllers['frameMaterial'] = TextEditingController(
      text: audit.frameMaterial,
    );
    fieldControllers['frameDimensions'] = TextEditingController(
      text: audit.frameDimensions,
    );
    fieldControllers['cornerJointQuality'] = TextEditingController(
      text: audit.cornerJointQuality,
    );
    fieldControllers['sealantApplication'] = TextEditingController(
      text: audit.sealantApplication,
    );
    fieldControllers['frameFlatness'] = TextEditingController(
      text: audit.frameFlatness,
    );
    fieldControllers['mountingHoleAlignment'] = TextEditingController(
      text: audit.mountingHoleAlignment,
    );
    fieldControllers['groundingHoleQuality'] = TextEditingController(
      text: audit.groundingHoleQuality,
    );
    ...
    fieldControllers['dimensionalAccuracy'] = TextEditingController(
      text: audit.dimensionalAccuracy,
    );
    ...
    fieldControllers['torqueReadings'] = TextEditingController(
      text: audit.torqueReadings,
    );
    fieldControllers['sealantBatchNumber'] = TextEditingController(
      text: audit.sealantBatchNumber,
    );
  ...
  Future<void> _saveFieldEdit(String fieldName) async {
    ...
    try {
      ...
      // Convert FramingAuditForm to AuditForm for compatibility with AuditService
  ...
  void _updateAuditField(String fieldName, String value) {
    ...
    switch (fieldName) {
      ...
      case 'moduleType':
        ...
        break;
      case 'frameType':
        audit.frameType = value;
        break;
      case 'frameMaterial':
        audit.frameMaterial = value;
        break;
      case 'frameDimensions':
        audit.frameDimensions = value;
        break;
      case 'cornerJointQuality':
        audit.cornerJointQuality = value;
        break;
      case 'sealantApplication':
        audit.sealantApplication = value;
        break;
      case 'frameFlatness':
        audit.frameFlatness = value;
        break;
      case 'mountingHoleAlignment':
        audit.mountingHoleAlignment = value;
        break;
      case 'groundingHoleQuality':
        audit.groundingHoleQuality = value;
        break;
      case 'surfaceFinish':
      ...
      case 'dimensionalAccuracy':
        audit.dimensionalAccuracy = value;
        break;
      case 'operatorName':
      ...
      case 'batchNumber':
        ...
        break;
      case 'torqueReadings':
        audit.torqueReadings = value;
        break;
      case 'sealantBatchNumber':
        audit.sealantBatchNumber = value;
        break;
      case 'defectCount':
  ...
  Future<void> _regeneratePdf() async {
    ...
    try {
      // Generate PDF
      final pdf = await PdfService.generateFramingPdf(audit, logoBytes);
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => PdfScreen(
            pdf: pdf,
            fileName: 'Framing_Audit_${audit.serialNumber}.pdf',
          ),
        ),
      );
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Framing Audit Details'),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 8),
                          _buildEditableField('frameType', 'Frame Type'),
                          _buildEditableField(
                            'frameMaterial',
                            'Frame Material',
                          ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildEditableField(
                            'mountingHoleAlignment',
                            'Mounting Hole Alignment',
                          ),
                          _buildEditableField(
                            'groundingHoleQuality',
